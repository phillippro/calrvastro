...
astro <- calc.astro(K=Ks,P=ps,e=es,inc=incs,omega=omegas,Omega=Omegas,E=Es,plx=plx,Mstar=mstars,pars=par.opt,eta=0)
...
points(0,0,pch='+')
inds <- sample(1:length(dra.mc),min(length(dra.mc),1e5))
