...
tmp <- run.metropolis.MCMC(startvalue,cov.start,iterations=floor(Niter/Ncores),tem=tem,bases=bases,RVonly=RVonly)
...
tmp <- run.metropolis.MCMC(startvalue,cov.start,iterations=floor(Niter/Ncores),tem=1,bases=bases,RVonly=RVonly)
