...
#'HD16160_natural_astro8_Niter14000000_Ncores4_ofac2_Nset6_Esd1_transit0_P29320_acc0.14_lnlmax',
...
#'HD182488_natural_astro8_Niter14000000_Ncores4_ofac2_Nset5_Esd1_transit0_P22325_acc0.055_lnlmax',
'HD190360_natural_astro8_Niter10000000_Ncores4_ofac2_Nset5_Esd1_transit0_P2851_acc1.8_lnlmax',
#'HD190406_abs1_astro8_Niter4000000_Ncores8_ofac2_Nset3_Esd1_transit0_P22992_acc0.026_lnlmax',
#'HD190406_abs1_astro8_Niter5000000_Ncores8_ofac2_Nset3_Esd1_transit0_P22168_acc0.7_lnlmax',
...
#'HD42581_natural_astro8_Niter10000000_Ncores4_ofac2_Nset5_Esd1_transit0_P39195_acc0.039_lnlmax',
#'HD4747_natural_astro8_Niter10000000_Ncores4_ofac2_Nset3_Esd1_transit0_P12649_acc2.1_lnlmax',
'HD4747_fix1_relativityFALSE_Niter1e.+06_Ncores4_ofac2_Nset3_Esd1_transit0_P12269',
'HIP2552_natural_astro8_Niter10000000_Ncores4_ofac2_Nset1_Esd1_transit0_P5655_acc0.03_lnlmax'
)
#fs <- 'HD4747_fix1_relativityFALSE_Niter1e.+06_Ncores4_ofac2_Nset3_Esd1_transit0_P12269'
...
for(f in fs){
    ...
    cat('input file:',ff,'\n')
    if(length(ff)==0){
        system(paste0('scp -azP ffeng@further.dtm.ciw.edu:Documents/projects/red3/results/',star,'/',f,'*Robj results/',star,'/'))
    }
...
stars0 <- stars
####loading data
fobj <- paste0('phase',version,'.Robj')
#if(file.exists(fobj)){
if(FALSE){
    if(!exists('out.phase')){
        load(fobj)
...
fout <- paste0('phase_coverage',version,'.pdf')
cat('output pdf:\n',fout,'\n')
pch.type <- 20
pch.size <- 1
Ncol <- 4
